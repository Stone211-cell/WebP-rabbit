...
export default function PlansPage() {
    const { stores, plans, fetchPlans, createPlan, updatePlan, deletePlan, isLoading: crmLoading, isValidating } = useCRM();
    const { profiles, isAdmin, currentUserProfile, isLoaded } = useCRMSession();

    const isInitialLoading = (crmLoading && plans.length === 0) || !isLoaded;
